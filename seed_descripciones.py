...
DATABASE_URL = os.getenv("'postgresql://neondb_owner:npg_jqNx96hatfHP@ep-holy-salad-ap6gq8ve-pooler.c-7.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require'")
